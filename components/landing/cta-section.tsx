...
import { Zap, Rocket, Sparkles, Award, TrendingUp, Search } from "lucide-react";
...
const tiles = [
  ...
  },
  {
    ...
    bg: (
      <div className="pointer-events-none absolute left-1/2 top-1/2 h-1/2 w-1/2 -translate-x-1/2 -translate-y-1/2 overflow-visible rounded-full bg-gradient-to-r from-purple-600 via-indigo-500 to-blue-400 opacity-70 blur-[20px] filter"></div>
    ),
  },
];
          ...
          <div className="relative flex w-full flex-col items-center justify-center overflow-hidden">
            ...
            <div className="absolute z-10">
              ...
              <div className="z-10 mt-4 flex flex-col items-center text-center text-primary">
                ...
                <p className="mt-2 max-w-md px-4">
                  Join hundreds of local businesses already thriving with our AI-powered solutions.
                </p>
